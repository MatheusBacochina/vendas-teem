  ...
  return (
    <div className="bg-black md:sticky top-0 z-50">
      <div className="container mx-auto flex py-5 px-4 md:gap-9 justify-between gap-4 flex-col md:flex-row items-center">
        ...
        <div className="w-[calc(100%-32px)] relative max-w-[376px] md:max-w-[437px] lg:max-w-[466px] flex items-center overflow-hidden h-[30px] bg-zinc-100 rounded-[17px]">
          <div className="bg-[#FF0505] absolute z-10 rounded-sm w-[90%] h-full animation_bar" />

          <span className="text-white absolute text-sm pl-4 font-roboto z-50">
